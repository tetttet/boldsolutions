...
import { GlobeDemo } from "./demo/GlobeDemo";
        ...
        <div className="py-12 md:py-20">
          ...
          {/* <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-zinc-800 md:text-4xl">
              Наши преимущества <Cover>Bold Solutions</Cover>
            </h2>
          </div> */}
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              Не просто настраиваем инструменты, а создаем экосистему, где каждый элемент усиливает другие. Instagram привлекает клиентов на сайт, сайт конвертирует их в заявки, таргет приводит новую аудиторию.
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-zinc-800">
                ...
                <span>Бизнес-ориентированность</span>
              </h3>
              <p className="text-[15px] text-zinc-500">
              Мы не гонимся за красивыми картинками ради картинок. Каждое решение подчинено главной цели — привлечению клиентов и росту вашей прибыли.
            ...
            <article>
              ...
              <p className="text-[15px] text-zinc-500">
              Вы всегда знаете, откуда приходят клиенты, что работает, а что нет. Мы предоставляем детальные отчеты и рекомендации по оптимизации.
            ...
            <article>
              ...
              <p className="text-[15px] text-zinc-500">
              Используем актуальные инструменты и следим за трендами, чтобы ваш бизнес был на шаг впереди конкурентов.
            ...
            <article>
              ...
              <p className="text-[15px] text-zinc-500">
              Наше сотрудничество не заканчивается на этапе настройки. Мы обучаем вашу команду и остаемся на связи для консультаций.
            ...
            <article>
              ...
              <p className="text-[15px] text-zinc-500">
              Мы понимаем, что каждый бизнес уникален. Поэтому мы разрабатываем решения, которые идеально подходят именно вам.
              </p>
            </article>
          </div>
        </div>
